...
-- -- during load (both pre and post functions get called almost instantly after each other repeatedly)
-- sdk.hook(sdk.find_type_definition("app.EnemyManager"):get_method("evSceneLoadBefore(System.Boolean)"),
-- 	function(args)
-- 		print("loading")
-- 	end,
-- 	function(retval)
...
-- try hooking app.HunterCharacter "update" method instead
-- sdk.hook(sdk.find_type_definition("app.PlayerManager"):get_method("lateUpdate"), update_hook, function(retval) end)

-- after loading
-- utils.HookThis("app.EnemyManager", "evSceneLoadEndCore(app.FieldDef.STAGE)",
-- 	function(args)
-- 		print("Doing stuff loading stage")
-- 	end,
-- 	function(retval)
-- 		print("Finished loading stage")
-- 	end)

-- sdk.hook(
-- 	sdk.find_type_definition("app.savedata.cItemParam"):get_method("getPouchItem(System.Int32)"), get_item)
-- imgui.text(tostring(get_item(2004)))
